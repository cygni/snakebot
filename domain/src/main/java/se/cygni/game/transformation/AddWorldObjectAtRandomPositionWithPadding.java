 ...
 */
public class AddWorldObjectAtRandomPositionWithPadding implements WorldTransformation {

    private final WorldObject worldObject;
    private final int padding;
    private XORShiftRandom random = new XORShiftRandom();

    public AddWorldObjectAtRandomPositionWithPadding(WorldObject worldObject, int padding) {
